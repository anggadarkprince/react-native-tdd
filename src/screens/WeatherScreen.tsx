      ...
      {status === Status.SUCCESS && (
        <>
          ...
          <View style={styles.stats}>
            ...
            <View testID="weather-screen-wind" style={[styles.card, styles.cardNegative]}>
              <Text style={styles.cardTextNegative}>wind</Text>
              <Text style={styles.cardTextNegative}>{weather.windSpeed}m/s</Text>
            </View>
            <View
